...
\begin{center}
\leavevmode
\includegraphics[width=316pt]{Identify_8h__dep__incl}
\end{center}
\end{figure}
\subsection*{Classes}
...
\begin{DoxyCompactList}\small\item\em Use the ID data to identify all possible candidates for an element. \end{DoxyCompactList}\end{DoxyCompactItemize}
