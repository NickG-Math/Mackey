...
\begin{center}
\leavevmode
\includegraphics[width=284pt]{Homology_8h__dep__incl}
\end{center}
\end{figure}
\subsection*{Classes}
...
\begin{DoxyCompactItemize}
\item 
{\footnotesize template$<$typename T , typename S $>$ }\\T \hyperlink{namespaceMackey_a6aa639a1f656fdcccbcfa6bc719bb817}{Mackey\+::normalize} (const T \&element, const S \&group)
