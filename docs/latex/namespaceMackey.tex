...
class \mbox{\hyperlink{classMackey_1_1Polynomial}{Polynomial}}
...
{\footnotesize template$<$typename p\+Scalar , typename T $>$ }\\std\+::vector$<$ p\+Scalar $>$ \mbox{\hyperlink{namespaceMackey_aa2823da3a4b93dca63e00e50a6bc9fdf}{changebasis}} (const T \&A, const T \&B)
...
{\footnotesize template$<$typename rank\+\_\+t , typename diff\+\_\+t , typename deg\+\_\+t $>$ }\\\mbox{\hyperlink{classMackey_1_1Massey}{Massey}}$<$ rank\+\_\+t, diff\+\_\+t $>$ \mbox{\hyperlink{namespaceMackey_afa8c8ea3bfdd5edbda71827e0b796fb1}{R\+O\+Massey}} (int level, const deg\+\_\+t \&first, const deg\+\_\+t \&second, const deg\+\_\+t \&third, bool do\+\_\+indeter)
...
{\footnotesize template$<$typename T $>$ }\\\mbox{\hyperlink{classMackey_1_1Polynomial}{Polynomial}}$<$ T $>$ \mbox{\hyperlink{namespaceMackey_a61f8cf9c3cf22acfedda5f427423f6c4}{operator+}} (const \mbox{\hyperlink{classMackey_1_1Polynomial}{Polynomial}}$<$ T $>$ \&a, const \mbox{\hyperlink{classMackey_1_1Polynomial}{Polynomial}}$<$ T $>$ \&b)
\item 
{\footnotesize template$<$typename T $>$ }\\\mbox{\hyperlink{classMackey_1_1Polynomial}{Polynomial}}$<$ T $>$ \& \mbox{\hyperlink{namespaceMackey_a29199dd05885558a19e305b49ab7b180}{operator+=}} (\mbox{\hyperlink{classMackey_1_1Polynomial}{Polynomial}}$<$ T $>$ \&a, const \mbox{\hyperlink{classMackey_1_1Polynomial}{Polynomial}}$<$ T $>$ \&b)
\item 
{\footnotesize template$<$typename T $>$ }\\\mbox{\hyperlink{classMackey_1_1Polynomial}{Polynomial}}$<$ T $>$ \mbox{\hyperlink{namespaceMackey_a76e1e4a6dac913bc86971d8515475fa5}{operator-\/}} (const \mbox{\hyperlink{classMackey_1_1Polynomial}{Polynomial}}$<$ T $>$ \&a)
\item 
{\footnotesize template$<$typename T $>$ }\\\mbox{\hyperlink{classMackey_1_1Polynomial}{Polynomial}}$<$ T $>$ \mbox{\hyperlink{namespaceMackey_a803f57e25754b9ca58e4757a46f9b23a}{operator-\/}} (const \mbox{\hyperlink{classMackey_1_1Polynomial}{Polynomial}}$<$ T $>$ \&a, const \mbox{\hyperlink{classMackey_1_1Polynomial}{Polynomial}}$<$ T $>$ \&b)
\item 
{\footnotesize template$<$typename T $>$ }\\\mbox{\hyperlink{classMackey_1_1Polynomial}{Polynomial}}$<$ T $>$ \& \mbox{\hyperlink{namespaceMackey_a9cb1fbb70826d41d001bef40d09d9e3f}{operator-\/=}} (\mbox{\hyperlink{classMackey_1_1Polynomial}{Polynomial}}$<$ T $>$ \&a, const \mbox{\hyperlink{classMackey_1_1Polynomial}{Polynomial}}$<$ T $>$ \&b)
\item 
{\footnotesize template$<$typename T $>$ }\\\mbox{\hyperlink{classMackey_1_1Polynomial}{Polynomial}}$<$ T $>$ \mbox{\hyperlink{namespaceMackey_a7bbd83e8170a608aea65f7d916b4bc6d}{operator$\ast$}} (const \mbox{\hyperlink{classMackey_1_1Polynomial}{Polynomial}}$<$ T $>$ \&a, const \mbox{\hyperlink{classMackey_1_1Polynomial}{Polynomial}}$<$ T $>$ \&b)
\item 
{\footnotesize template$<$typename T $>$ }\\std\+::pair$<$ \mbox{\hyperlink{classMackey_1_1Polynomial}{Polynomial}}$<$ T $>$, \mbox{\hyperlink{classMackey_1_1Polynomial}{Polynomial}}$<$ T $>$ $>$ \mbox{\hyperlink{namespaceMackey_a04fadcf186ab504cafeb259178ee4827}{divide}} (const \mbox{\hyperlink{classMackey_1_1Polynomial}{Polynomial}}$<$ T $>$ \&a, const \mbox{\hyperlink{classMackey_1_1Polynomial}{Polynomial}}$<$ T $>$ \&b)
\item 
{\footnotesize template$<$typename T $>$ }\\\mbox{\hyperlink{classMackey_1_1Polynomial}{Polynomial}}$<$ T $>$ \mbox{\hyperlink{namespaceMackey_ac26fb6e8a8b7350d13f866570d588e6c}{operator/}} (const \mbox{\hyperlink{classMackey_1_1Polynomial}{Polynomial}}$<$ T $>$ \&a, const \mbox{\hyperlink{classMackey_1_1Polynomial}{Polynomial}}$<$ T $>$ \&b)
\item 
{\footnotesize template$<$typename T $>$ }\\\mbox{\hyperlink{classMackey_1_1Polynomial}{Polynomial}}$<$ T $>$ \mbox{\hyperlink{namespaceMackey_adb145e729d40138080b5a58d26a89388}{operator\%}} (const \mbox{\hyperlink{classMackey_1_1Polynomial}{Polynomial}}$<$ T $>$ \&a, const \mbox{\hyperlink{classMackey_1_1Polynomial}{Polynomial}}$<$ T $>$ \&b)
\item 
{\footnotesize template$<$typename T $>$ }\\\mbox{\hyperlink{classMackey_1_1Polynomial}{Polynomial}}$<$ T $>$ \mbox{\hyperlink{namespaceMackey_a2b9319a9af0a3cad8cfec47e9197dc82}{geometric}} (int max)
...
\begin{center}
\leavevmode
\includegraphics[width=347pt]{namespaceMackey_a65dac6a38a02a4efc56d52292ea8cbd8_cgraph}
\end{center}
\end{figure}
Here is the caller graph for this function\+:
\nopagebreak
...
{\footnotesize\ttfamily template$<$typename T $>$ \\
std\+::pair$<$\mbox{\hyperlink{classMackey_1_1Polynomial}{Polynomial}}$<$T$>$, \mbox{\hyperlink{classMackey_1_1Polynomial}{Polynomial}}$<$T$>$ $>$ Mackey\+::divide (\begin{DoxyParamCaption}\item[{const \mbox{\hyperlink{classMackey_1_1Polynomial}{Polynomial}}$<$ T $>$ \&}]{a,  }\item[{const \mbox{\hyperlink{classMackey_1_1Polynomial}{Polynomial}}$<$ T $>$ \&}]{b }\end{DoxyParamCaption})}
...
\begin{center}
\leavevmode
\includegraphics[width=315pt]{namespaceMackey_a04fadcf186ab504cafeb259178ee4827_icgraph}
\end{center}
\end{figure}
...
{\footnotesize\ttfamily template$<$typename T $>$ \\
\mbox{\hyperlink{classMackey_1_1Polynomial}{Polynomial}}$<$T$>$ Mackey\+::geometric (\begin{DoxyParamCaption}\item[{int}]{max }\end{DoxyParamCaption})}
...
\begin{center}
\leavevmode
\includegraphics[width=291pt]{namespaceMackey_a1ff253bf7e043ad6455b5fea23a83f09_cgraph}
\end{center}
\end{figure}
...
\begin{center}
\leavevmode
\includegraphics[width=325pt]{namespaceMackey_a8c1525b210b4699780bbe05cb16f0e7b_cgraph}
\end{center}
\end{figure}
Here is the caller graph for this function\+:
\nopagebreak
...
\begin{center}
\leavevmode
\includegraphics[width=306pt]{namespaceMackey_af70b0c547f7121b8815885dfebde67d9_cgraph}
\end{center}
\end{figure}
Here is the caller graph for this function\+:
\nopagebreak
...
{\footnotesize\ttfamily template$<$typename T $>$ \\
\mbox{\hyperlink{classMackey_1_1Polynomial}{Polynomial}}$<$T$>$ Mackey\+::operator\% (\begin{DoxyParamCaption}\item[{const \mbox{\hyperlink{classMackey_1_1Polynomial}{Polynomial}}$<$ T $>$ \&}]{a,  }\item[{const \mbox{\hyperlink{classMackey_1_1Polynomial}{Polynomial}}$<$ T $>$ \&}]{b }\end{DoxyParamCaption})}
...
\begin{center}
\leavevmode
\includegraphics[width=315pt]{namespaceMackey_adb145e729d40138080b5a58d26a89388_cgraph}
\end{center}
\end{figure}
...
{\footnotesize\ttfamily template$<$typename T $>$ \\
\mbox{\hyperlink{classMackey_1_1Polynomial}{Polynomial}}$<$T$>$ Mackey\+::operator$\ast$ (\begin{DoxyParamCaption}\item[{const \mbox{\hyperlink{classMackey_1_1Polynomial}{Polynomial}}$<$ T $>$ \&}]{a,  }\item[{const \mbox{\hyperlink{classMackey_1_1Polynomial}{Polynomial}}$<$ T $>$ \&}]{b }\end{DoxyParamCaption})}
...
\doxysubsubsection{\texorpdfstring{operator+=()}{operator+=()}}
{\footnotesize\ttfamily template$<$typename T $>$ \\
\mbox{\hyperlink{classMackey_1_1Polynomial}{Polynomial}}$<$T$>$\& Mackey\+::operator+= (\begin{DoxyParamCaption}\item[{\mbox{\hyperlink{classMackey_1_1Polynomial}{Polynomial}}$<$ T $>$ \&}]{a,  }\item[{const \mbox{\hyperlink{classMackey_1_1Polynomial}{Polynomial}}$<$ T $>$ \&}]{b }\end{DoxyParamCaption})}
...
{\footnotesize\ttfamily template$<$typename T $>$ \\
\mbox{\hyperlink{classMackey_1_1Polynomial}{Polynomial}}$<$T$>$ Mackey\+::operator-\/ (\begin{DoxyParamCaption}\item[{const \mbox{\hyperlink{classMackey_1_1Polynomial}{Polynomial}}$<$ T $>$ \&}]{a }\end{DoxyParamCaption})}
...
\begin{center}
\leavevmode
\includegraphics[width=309pt]{namespaceMackey_ac26fb6e8a8b7350d13f866570d588e6c_cgraph}
\end{center}
\end{figure}
