...
Finally, if only the connectivity of the Multiplication Graph is desired, as opposed to precise factorizations of the generators, you can instead include "Mackey/MultiplicationGraph_Connectivity" and call

<CODE>auto M= MultiplicationGraphConnectivity<rank_t, diff_t>({ -5,-5 }, { 5,5 }, { {0,1,0},{2,2,0},{0,0,1},{2,0,1} }, { "asigma", "u2sigma", "alambda", "ulambda" });</CODE>

and then

<CODE>M.compute_with_sources({[0,0,0]}, {"1"});</CODE>

The vector <CODE>M.trully_disconnected<CODE> contains the generators that are not connected to any sources.
