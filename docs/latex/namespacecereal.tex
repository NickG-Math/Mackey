...
\item 
{\footnotesize template$<$typename Archive , typename T , int Rows\+At\+Compile\+Time, int Cols\+At\+Compile\+Time, int Options, int Max\+Rows\+At\+Compile\+Time, int Max\+Cols\+At\+Compile\+Time$>$ }\\void \mbox{\hyperlink{namespacecereal_afd0f4831f36c8d183e4ff80c96b6b9ed}{save}} (Archive \&archive, const Eigen\+::\+Matrix$<$ T, Rows\+At\+Compile\+Time, Cols\+At\+Compile\+Time, Options, Max\+Rows\+At\+Compile\+Time, Max\+Cols\+At\+Compile\+Time $>$ \&A)
...
\begin{DoxyCompactList}\small\item\em Load \mbox{\hyperlink{namespaceEigen}{Eigen}} dense matrix. \end{DoxyCompactList}\end{DoxyCompactItemize}
...
Load \mbox{\hyperlink{namespaceEigen}{Eigen}} dense matrix. 
...
Save \mbox{\hyperlink{namespaceEigen}{Eigen}} dense matrix. 
